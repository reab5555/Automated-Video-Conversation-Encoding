...
This project provides an automated Kubernetes-based video encoding solution leveraging GCS storage, with watch folder functionality for automated processing, converting a video to another format.
